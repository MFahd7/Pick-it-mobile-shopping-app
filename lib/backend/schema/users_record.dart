...
class UsersRecord extends FirestoreRecord {
  ...
  // "buildingNo" field.
  int? _buildingNo;
  int get buildingNo => _buildingNo ?? 0;
  bool hasBuildingNo() => _buildingNo != null;

  // "apartmentNo" field.
  int? _apartmentNo;
  int get apartmentNo => _apartmentNo ?? 0;
  ...
  void _initializeFields() {
    ...
    _buildingNo = castToType<int>(snapshotData['buildingNo']);
    _apartmentNo = castToType<int>(snapshotData['apartmentNo']);
