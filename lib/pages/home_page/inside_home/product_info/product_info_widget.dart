...
class ProductInfoWidget extends StatefulWidget {
  ...
  final DocumentReference? insideProduct;
...
class _ProductInfoWidgetState extends State<ProductInfoWidget>
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<PostProductRecord>(
      stream: PostProductRecord.getDocument(widget.insideProduct!),
      builder: (context, snapshot) {
        ...
        final productInfoPostProductRecord = snapshot.data!;
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      productInfoPostProductRecord.name,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      productInfoPostProductRecord.description,
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium,
                                    ).animateOnPageLoad(animationsMap[
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: FlutterFlowCountController(
                                      ...
                                      count: _model.countQtyValue1 ??= 1,
                                      updateCount: (count) => setState(
                                          () => _model.countQtyValue1 = count),
                                      stepSize: 1,
                                      minimum: 1,
                                    ),
                                  ),
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    0.0, 0.0, 10.0, 0.0),
                                            child: Text(
                                              'EGP ${productInfoPostProductRecord.onSale != null ? functions.sum(productInfoPostProductRecord.salePrice, _model.countQtyValue1!).toString() : functions.sum(productInfoPostProductRecord.price, _model.countQtyValue1!).toString()}',
                                            ...
                                            children: [
                                              InkWell(
                                                ...
                                                highlightColor:
                                                    Colors.transparent,
                                                onTap: () async {
                                                  if (productInfoPostProductRecord
                                                          .onSale !=
                                                      null) {
                                                    FFAppState().update(() {
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: FlutterFlowCountController(
                                      ...
                                      count: _model.countQtyValue2 ??= 1,
                                      updateCount: (count) => setState(
                                          () => _model.countQtyValue2 = count),
                                      stepSize: 1,
                                      minimum: 1,
                                    ),
                                  ),
