...
import 'product_list_health_model.dart';
export 'product_list_health_model.dart';

class ProductListHealthWidget extends StatefulWidget {
  const ProductListHealthWidget({
    Key? key,
    this.whichCategory,
  }) : super(key: key);
  ...
  @override
  _ProductListHealthWidgetState createState() =>
      _ProductListHealthWidgetState();
}

class _ProductListHealthWidgetState extends State<ProductListHealthWidget> {
  late ProductListHealthModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProductListHealthModel());
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<PostProductRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<PostProductRecord> productListHealthPostProductRecordList =
            snapshot.data!;
                                      ...
                                      child: Padding(
                                        ...
                                        child: Autocomplete<String>(
                                          ...
                                          optionsBuilder: (textEditingValue) {
                                            ...
                                            return productListHealthPostProductRecordList
                                                .map((e) => e.name)
                                                .toList()
                                                .where((e) =>
                                                    widget.whichCategory ==
                                                    productListHealthPostProductRecordList
                                                        .first.categoryName)
                                                .toList()
                                                .where((option) {
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'kqfaymhp' /* Search for the product... */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall,
                                            ...
                                            return TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'ihwwdlps' /* Search for the product... */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall,
                                            ...
                                            return TextFormField(
                                              ...
                                              decoration: InputDecoration(
                                                labelText:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'or8f4ry6' /* Search for the product... */,
                                                ),
                                                labelStyle:
                                                    FlutterFlowTheme.of(context)
                                                        .bodySmall,
